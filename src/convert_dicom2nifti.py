...
if __name__ == '__main__':
    ...
    # dicom2nifti.convert_directory('/media/liu_cheng/MyPassport/unet3d/LUNA16/inference/E5304567', '/media/liu_cheng/MyPassport/unet3d/LUNA16/inference')
    # python convert_dicom2nifti.py --data_path='../LUNA16/inference/E5304567' --output_path='../LUNA16/inference'
    dicom2nifti.convert_directory(config.data_path, config.output_path)
